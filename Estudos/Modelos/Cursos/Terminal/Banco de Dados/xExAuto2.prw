...
/*		If !MsSeek(xFilial("SB1")+aDados[1])
		...
		aDadosInc	:= {{"B1_COD"   ,aDados[2]		,NIL},;
		             {"B1_DESC"  ,aDados[3] 	,NIL},;
		             {"B1_TIPO"  ,aDados[7]		,Nil},;
		             {"B1_UM"    ,aDados[6]		,Nil},;
		             {"B1_LOCPAD",aDados[4]		,Nil},;
		             {"B1_GRUPO" ,aDados[5]		,Nil}}
	
		MSExecAuto({|x,y| Mata010(x,y)},aDadosInc,nOpc)
