...
//StrTran( cString , cSearch >) :pesquisa e substitui um conjunto de caracteres de uma string.
//
//StrTran( "AAAAACD", "A", "B" ) ) -> BBBBBCD

//FwNoAccent( <cTexto> ) Retira caracteres especiais do texto Informado
// FwNoAccent('Até / Olá / É / ó / Ó / Vô / ão / ç ') ->'Ate / Ola / E / o / O / Vo / ao / c '
