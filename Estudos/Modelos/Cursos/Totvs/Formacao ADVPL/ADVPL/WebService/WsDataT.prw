...
/* ===============================================================================
WSDL Location    http://localhost:8089/ws/XWSHORARIODF.apw?WSDL
Gerado em        06/29/19 14:00:27
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _FARRZRJ ; Return  // "dummy" function - Internal Use 
...
cSoap += '<GETDATA xmlns="http://localhost:8089/">'
cSoap += WSSoapValue("X", ::cX, cX , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</GETDATA>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://localhost:8089/GETDATA",; 
	"DOCUMENT","http://localhost:8089/",,"1.031217",; 
	"http://localhost:8089/ws/XWSHORARIODF.apw")
...
cSoap += '<GETHORA xmlns="http://localhost:8089/">'
cSoap += WSSoapValue("X", ::cX, cX , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</GETHORA>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://localhost:8089/GETHORA",; 
	"DOCUMENT","http://localhost:8089/",,"1.031217",; 
	"http://localhost:8089/ws/XWSHORARIODF.apw")
