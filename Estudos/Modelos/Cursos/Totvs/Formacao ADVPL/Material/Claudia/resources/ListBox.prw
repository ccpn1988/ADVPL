...
Private oDlg
Private oLbx1,oLbx2,oLbx3,oLbx4,oLbx4
Private oFld
Private oBtn  
...
//===================================================================== Folder 1 - Cliente ======================================================================
                                                                                                             //TAM OBJ        
@ 005,005 LISTBOX oLbx1 FIELDS HEADER 	"Cod.Cliente","Loja","Nome ","Estado","Ultima Compra","Bloqueado" SIZE 456,205 PIXEL OF oFld:aDialogs[1] //ABA1
oLbx1:SetArray(aCliente)       //REGISTRO POSICIONADO
...
//===================================================================== Folder 4 - aSucata ======================================================================
@ 005,005 LISTBOX oLbx4 FIELDS HEADER 	"Codigo ","Data ", "Nome ","Produto"  SIZE 456,205 PIXEL OF oFld:aDialogs[4] ///colsizes 35,25,50,20,
oLbx4:SetArray(aSucata)
oLbx4:bLine := { || {	aSucata[oLbx4:nAt,01],aSucata[oLbx4:nAt,02],aSucata[oLbx4:nAt,03],aSucata[oLbx4:nAt,04] } } 							
...
dbUseArea( .T.,"TOPCONN", TCGENQRY(,,cSql),(cAliasSuc), .F., .T.)

If Select( cAliasSuc ) == 0
	(cAliasSuc)->( dbCloseArea() )
EndIf	

dbSelectArea( cAliasSuc )
(cAliasSuc)->( dbGoTop() )
