...
/*
Cláudia Balestri - Modelo 2 - 04/05/2019
*/

User Function XCADMOD2() //NOME DO FONTE TEM QUE SER IGUAL AO NOME DA FUNÇÃO PRINCIPAL
	...
	if nOpc == 3 //Incluir
			...
			For nLinha :=1 to Len(aCols) //Quantidade de Linha
	            ...
	            For nCampo := 1 to len(aHeader)
	                ...
	                //(cAlias)->&(FieldName(nCampo)):= M->&(FieldName(nCampo)) não trata campo virtual
