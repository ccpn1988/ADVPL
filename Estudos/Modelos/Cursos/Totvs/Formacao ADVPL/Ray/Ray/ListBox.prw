...
//===================================================================== Folder 4 - aProdutos ======================================================================
@ 005,005 LISTBOX oLbx4 FIELDS HEADER 	"Código ","Quantidade ", "Valor ","Ativo" colsizes 35,25,50,20, SIZE 456,205 PIXEL OF oFld:aDialogs[4]
oLbx4:SetArray(aSz0)
oLbx4:bLine := { || {	aSz0[oLbx4:nAt,01],aSz0[oLbx4:nAt,02],aSz0[oLbx4:nAt,03],aSz0[oLbx4:nAt,04] } } 							
...
While ! (cAliasSucata)->(EOF())
	 ...
	 AADD ( aSz0, { (cAliasSucata)->Z0_PROD,;
	 				(cAliasSucata)->Z0_QTD,;
					(cAliasSucata)->Z0_VALOR,;
					(cAliasSucata)->Z0_ATIVO })
					(cAliasSucata)->(dbSkip())
