...
±±³Fun‡…o    ³ GENR401   ³ Autor ³ Helimar Tavares       ³ Data ³ 27/01/15 ³±±
...
//@GEN - alterada o nome da funcao em user function
User Function GENR401()
Local oReport
...
//@GEN - copiada a chamada do relatorio treport
oReport:= ReportDef()
oReport:PrintDialog()
...
oReport:= TReport():New("GENR401",STR0001,"MTR260",,)
...
oReport:= TReport():New("GENR401",STR0001,"MTR260", {|oReport| ReportPrint(oreport,aOrdem,cAliasTRB)},STR0002+" "+STR0003+" "+STR0004) //"Relacao da Posicao do Estoque"
...
//@GEN - Retirados o codigo do produto, tipo, grupo, UM. 2a. UM, VALOR, VALORR, descricao do armazem
...
TRCell():New(oSection,'B1_ISBN'		,'SB1',,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)    

TRCell():New(oSection,'TPPLB'		,'','Tp Publ'	,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) //B1_XIDTPPU
//--//TRCell():New(oSection,'SELO'		,'','Selo'		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) //B5_XSELO

TRCell():New(oSection,'B1_DESC'		,'SB1',STR0039,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)

//--//TRCell():New(oSection,'SITOBR'		,'','Sit Obra',/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) //B1_XSITOBR
...
TRCell():New(oSection,'B2_QTNP'		,'SB2','Qt.Ter.Ns.Pd',cPictQT						   							,aSizeQT[1],/*lPixel*/,/*{|| code-block de impressao }*/,,,"RIGHT")
TRCell():New(oSection,'B2_QNPT'		,'SB2','Qt.Ns.Pd.Ter',cPictQT						   							,aSizeQT[1],/*lPixel*/,/*{|| code-block de impressao }*/,,,"RIGHT")"
...
_oTempTab	:= FWTemporaryTable():New(cAliasTRB)
_oTempTab:SetFields( aCampos ) // seta os campos que serão utilizados na tabela temporária
_oTempTab:AddIndex("1", Separa(cIndxKEY,"+"))
	...
	If lVersao	
		...
		BeginSql Alias cAliasSB2
				SELECT B2_FILIAL, B2_LOCAL, B2_COD, B2_QATU, B2_QTSEGUM, B2_QFIM, B2_QFIM2, B2_VATU1, B2_VATU2, 
						...
						B2_QEMPPR2, B2_VFIM2, B2_VFIM3, B2_VFIM4, B2_VFIM5, B1_COD, B1_ISBN, B1_FILIAL, B1_TIPO, B1_GRUPO,
						B1_DESC, B1_GRUPO, B1_CUSTD, B1_UPRC, B1_MCUSTD, B1_SEGUM, B1_UM, B1_CODITE, NNR_DESCRI, 
						B2_SALPPRE, B2_QEPRE2, B2_QTNP, B2_QNPT, Trim(SX5_1.X5_DESCRI)    
						%Exp:cSelect%
		
				FROM %table:SB2% SB2,%table:SB1% SB1,%table:NNR% NNR
				
				LEFT JOIN %table:SX5% SX5_1 ON SX5_1.X5_FILIAL = %Exp:xfilial("SX5")%
				AND SX5_1.X5_TABELA = %Exp:"00"%
				AND SX5_1.X5_CHAVE = SB1.B1_XIDTPPU
...
_oTempTab2	:= FWTemporaryTable():New(cFileTRB)
_oTempTab2:SetFields( aCampos ) // seta os campos que serão utilizados na tabela temporária
_oTempTab2:AddIndex("1", Separa(cIndxKEY,"+"))
_oTempTab2:Create() // Cria a tabela temporária
...
oObj:AddGroup("MTR260")
oObj:SearchGroup()

If lCusUnif //-- Ajusta as perguntas para Custo Unificado

	oSX1 := FWSX1Util():New()
	oSX1:AddGroup("MTR260")
	oSX1:SearchGroup()
