...
_cQuery := " SELECT MAG.PAGAMENTO, MAG.CODIGO_CUPOM, SC6.C6_XPEDWEB NUM, SC6.C6_NUM, SA1.A1_CGC CPF, SA1.A1_NOME RAZAO, MAG.SOBRENOME, SA1.A1_EMAIL EMAIL, SA1.A1_EST UF, SA1.A1_MUN CIDADE, SA1.A1_TEL TELEFONE,"+cQuebra
...
_cQuery += "        SD2.D2_DESC VAL_DESC, DA1.DA1_PRCVEN PRECO_ATUAL, MAG.GRUPOCLIENTE,"+cQuebra
...
_cQuery += " AND TRIM(SA1.A1_XCANALV) = '3'
...
_cQuery += "            ON PG.PEDIDO_ENTITY_ID = PED.ENTITY_ID"+cQuebra
_cQuery += "            LEFT JOIN GENESB.GRUPOS_CLIENTES GC"+cQuebra
_cQuery += "            ON GC.GROUP_ID = PED.GROUP_ID) MAG"+cQuebra
