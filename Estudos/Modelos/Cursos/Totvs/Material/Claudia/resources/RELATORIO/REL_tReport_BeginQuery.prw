...
oSection := TRSection():New(oReport,"Dados dos Clientes",{"SA1"},{"UF","A1_COD"} )
	...
	TRCell():New(oSection,"CODIGO"    ," SA1","Cliente")
...
TRFunction():New(oSection:Cell("CODIGO"), NIL, "COUNT", oBreak)
...
BeginSql alias "QRYSA1"
	...
	ORDER BY A1_EST, A1_COD, A1_LOJA // TEM QUE SER A ORDEM DA QUEBRA (A1_EST)
