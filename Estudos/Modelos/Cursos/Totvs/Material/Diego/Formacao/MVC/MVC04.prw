...
Static Function MenuDef()
	...
	AADD( aRotina, {"Analise de Crédito" , 'VIEWDEF.MVC04', 0, 4 , 0})
	/* OBSERVAÇÕES
...
Local lRet := .T.
	RecLock("SA1",.F.)
		...
		Help(NIL, NIL, "Atenção", NIL, "Alteração Contato", 1, 0, NIL, NIL, NIL, NIL, NIL, {"Contato Alterado com sucesso!"})		
	MsUnLock() 
Return (lRet)
...
oStruct:AddField( 'A1_COD','1','Código','Código',, 'Get' ,,,,.F.,,,,,,.T.,, )
...
oStruct:AddField('Número','Numero do Título' , 'E1_NUM', 'C', 9, 0, , , {}, .F., , .F., .F., .T., , )
oStruct:AddField('Parcela','Numero Parcela' , 'E1_PARCELA', 'C', 2, 0, , , {}, .F., , .F., .F., .T., , )
oStruct:AddField('Prefixo','Prefixo do Tíluto' , 'E1_PREFIXO', 'C', 5, 0, , , {}, .F., , .F., .F., .T., , )
oStruct:AddField('Emissão','Data de Emissão' , 'E1_EMISSAO', 'D', 8, 0, , , {}, .F., , .F., .F., .T., , )
