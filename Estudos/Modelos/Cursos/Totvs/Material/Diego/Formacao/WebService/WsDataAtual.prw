...
WsService xWsDataAtual Description "Data Atual"
	...
	WsMethod GetHorario Description "Retorna o Horário Atual do Servidor"
		WsData cRetTime as String
		
	WsMethod GetDataAtual Description "Retorna o Horário Atual do Servidor"
...
WsMethod GetDataAtual WsReceive cEnvio WsSend cRetData WsService xWsDataAtual
	If cEnvio == '123'
		self:cRetData := Date()
	Else
		SetSoapFault("Método não Disponivel", "Senha Invalida.")	
		Return .F.
	EndIf	
Return .T.
