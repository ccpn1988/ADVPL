...
User Function RELSZ1()
	...
	/*USA FRAMEWORK COLOCAMOS COMO FALSE*/		
	Pergunte("RELSZ0",.F.)	
	
	/*PERGUNTA ANTES DE EXTRAIR OS RELATORIO PEDE OS PARAMETROS*/		
	//Pergunte("RELSZ0",.T.)		
...
Static Function RptDef()
	...
	oReport := TReport():New("RELSZ1","Cadastro de Sucata","RELSZ0",{|oReport| ReportPrint(oReport)},"Dados dos pedidos")
