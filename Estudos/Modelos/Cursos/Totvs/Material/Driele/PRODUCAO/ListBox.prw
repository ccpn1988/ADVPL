...
//===================================================================== Folder 3 - aProdutos ======================================================================
@ 005,005 LISTBOX oLbx3 FIELDS HEADER 	"Produto ","Descriçao ", "Tipo ","Bloqueado" SIZE 456,205 PIXEL OF oFld:aDialogs[3]
...
//===================================================================== Folder 4 - aSucata ======================================================================
@ 005,005 LISTBOX oLbx4 FIELDS HEADER 	"Produto ","Descriçao ", "Quantidade ","Status" colsizes 35,25,50,20, SIZE 456,205 PIXEL OF oFld:aDialogs[4]
...
Local cAliasSucat := GetNextAlias()  
...
If Select( cAliasSucat ) == 0
	(cAliasProd)->( dbCloseArea() )
EndIf	     

 dbSelectArea( cAliasSucat  )
 (cAliasSucat )->( dbGoTop() ) 
 
 aSucata := {} 

While ! (cAliasSucat)->(EOF())
        
	 AADD ( aSucata, { (cAliasSucat)-> Z0_COD   ,;
	 							(cAliasSucat)->Z0_PROD  ,;
							   (cAliasSucat)->Z0_QTD   ,;
						  ((cAliasSucat)->Z0_ATIVO) } )  
