...
If lOk
	...
	If !Empty( aMarcadas )
		...
		Else
			MsgStop( 'Atualiza็ใo nใo Realizada.', 'Aten็ใo' )
...
aAdd( aSX2, { ;
	...
	'Exemplo Modelo3'													   , ; //X2_NOME
	'Exemplo Modelo3'													   , ; //X2_NOMESPA
	'Exemplo Modelo3'													    , ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	'C'																		, ;//'X2_MODOUN' 
	'C'																		, ;//'X2_MODOEMP'
...
aAdd( aSX2, { ;
	...
	'Tabela Filho'														, ; //X2_NOME
	'Tabela Filho'														, ; //X2_NOMESPA
	'Tabela Filho'														, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	'C'																		, ;//'X2_MODOUN' 
	'C'																		, ;//'X2_MODOEMP'
...
aAdd( aSX3, { ;
	...
	'Descri็ใo'															, ; //X3_TITSPA
	'Descri็ใo'															, ; //X3_TITENG
	'Descri็ใo'															, ; //X3_DESCRIC
	'Descri็ใo'															, ; //X3_DESCSPA
	'Descri็ใo'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZ2'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'Z2_FILIAL+Z2_CODFOR+Z2_LOJAFOR'													, ; //CHAVE
	'Fornedor'																	, ; //DESCRICAO
	'Fornedor'																	, ; //DESCSPA
	'Fornedor'																	, ; //DESCENG
	'U'																		, ; //PROPRI
...
aAdd( aSX7, { ;
	...
	'Z2_NOMEFOR'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'SA2'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'xFilial("SA2")+M->Z2_CODFOR'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
