	...
	Do While cChavCli == Alltrim((_cArqTmp)->C5_XPEDWEB)+(_cArqTmp)->C5_EMISSAO
		...
		If Empty(_cMsg)
			...
			Else
				...
				IF Empty(_cUf) .OR. Empty(_cCdMun) .OR. !ExistCpo("CC2",_cUf+_cCdMun)
					IF !U_GENA095C(_cCep,@_cUf,@_cEst,@_cCdMun,@_cMunic,,@_cBairro)
			...
			aAdd(_aClient,{"A1_BAIRRO"	,	_cBairro												,Nil})
