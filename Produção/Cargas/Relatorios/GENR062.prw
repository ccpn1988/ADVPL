...
ฑฑบPrograma  ณGENR062   บAutor  ณCleuto Lima - Loop  บ Data ณ  06/01/16   บฑฑ
...
TRCell():New(oSection1,"SITUACAO"	,cQryAlias,"Situa็ใo"		,,50)
...
//ณAUX_SIGAMAT: tabela auxiliar com os dados do sigamatณ
...
cQuery += ' ,CASE WHEN "VALOR DESTINO" IS NULL THEN '+"'NOTA NรO ENCONTRADA NO DESTINO' WHEN "+'"VALOR DESTINO" <> "VALOR ORIGEM" THEN '+"'NOTA ORIGEM COM VALOR DIVERGENTE DA NOTA DESTINO' ELSE 'NOTA OK' END SITUACAO, CHVNFE "+cQuebra
cQuery += " FROM ( "+cQuebra
...
PutSx1(cPerg,"05","Situa็ใo"			,"Situa็ใo"				,"Situa็ใo"						,"mv_ch5" ,"N"	,1							,0		 	,		 ,"C"  ,""									,""		,""	   ,"","mv_par05","Todas","Todas","Todas","","Notas Corretas","Notas Corretas","Notas Corretas","Notas Inconsistentes","Notas Inconsistentes","Notas Inconsistentes","","","","","","",nil,nil,nil,	"")
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
