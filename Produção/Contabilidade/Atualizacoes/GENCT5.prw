...
±±ºPrograma  ³GENTCT5   ºAutor  ³Danilo Azevedo      º Data ³  04/11/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Tratamento de contabilizacao                                º±±
±±º          ³                                                            º±±
...
If cCampo == "CT5_DEBITO"
	...
	// Cleuto - 10/03/2017 - Regra antiga substituida para o projeto de parcelamento do cartão de credito
	...
	*/
	...
	If cEstorno == "N"
		If AllTrim(SE5->E5_MOTBX)+"#" $ "CIE#RDC#AMX#STO#GET#"
			If cTipo == "AB-"
				xRet := "43010109"
			Else
		...
		If AllTrim(SE5->E5_MOTBX)+"#" $ "CIE#RDC#AMX#STO#GET#"
			Do Case
				...
				Case AllTrim(SE5->E5_MOTBX)+"#" $ "STO#" //STONE
					xRet := "11020111"
				Case AllTrim(SE5->E5_MOTBX)+"#" $ "GET#" //GETNET
					xRet := "11020109"										
			EndCase
		Else
			xRet := SA1->A1_CONTA
...
ElseIf cCampo == "CT5_VLR1" .AND. cTipo == "AB-"	
	...
	If AllTrim(SE5->E5_MOTBX)+"#" $ "CIE#RDC#AMX#STO#GET#"
		...
		//SE1->(DBSetNickname("TITPAI"))//Prefixo + Número + Parcela + Tipo + Cliente + Loja
		SE1->(DbSetOrder(28))//Prefixo + Número + Parcela + Tipo + Cliente + Loja
