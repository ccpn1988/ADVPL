...
While !LockByName("GENMC01J",.T.,.T.,.T.)
	...
	Sleep(10)
	If nX > 2     
		Conout("GENMC01J - Nใo foi possํvel executar a job neste momento pois a fun็ใo GENMC01J jแ esta sendo executada por outra processamento!"+DTOC(DDataBase)+" "+Time())
		Return .F.
    EndIf
EndDo
