...
U_GENA011({_cPrTipo,_cFornece,_cLojafor,_dRef})
...
If upper(alltrim(GetEnvServer())) $ "SCHEDULE" //EXECUTA SOMENTE NO AMBIENTE SCHEDULE
	...
	conout(Time()+ " " + "GENA011 - Tipo: " + _cParam1 )
										...
										*/
										...
										If _nPrcVn > 0
											...
											If cRetInter == "P"
												...
												_cQuery += " B6_SERIE, B6_CLIFOR, B6_LOJA, D1_ITEM, B6_IDENT, D1_LOCAL, (D1_VALDESC/D1_TOTAL) DESCONTO,
											...
											Else
												...
												Else
													_cQuery += " (SELECT (SD2_1.D2_QUANT - SD2_1.D2_QTDEDEV)
												...
												//If _cFornece <> "0378128"
												If _cFornece <> "AAA"
													_cQuery += " AND (SELECT (SD2.D2_QUANT - SD2.D2_QTDEDEV)
											...
											If (_cAliQry5)->(!EOF())
												...
												While (_cAliQry5)->(!EOF())
													...
													If _nQtdB6 = 0
														...
														aAdd(_aSldB6,{_nQtdSld, (_cAliQry5)->B6_DOC, (_cAliQry5)->B6_SERIE, (_cAliQry5)->D1_ITEM, (_cAliQry5)->B6_IDENT,(_cAliQry5)->D1_VUNIT,(_cAliQry5)->D1_LOCAL,(_cAliQry5)->DESCONTO})
														Exit
													EndIf
													...
													If _nQtdB6 > 0
														...
														aAdd(_aSldB6,{_nSldB6Comp, (_cAliQry5)->B6_DOC, (_cAliQry5)->B6_SERIE, (_cAliQry5)->D1_ITEM, (_cAliQry5)->B6_IDENT,(_cAliQry5)->D1_VUNIT,(_cAliQry5)->D1_LOCAL,(_cAliQry5)->DESCONTO})
