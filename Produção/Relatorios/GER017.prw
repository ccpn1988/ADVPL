...
ฑฑบPrograma  ณGER017    บAutor  ณErica Vieites       บ Data ณ  24/03/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRelatorio de Alerta de Reimpressใo                          บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
oReport := TReport():New("GER017","GER017 - ALERTA DE REIMPRESSยO",cPerg,{|oReport| PrintReport(oReport)},"GER017 - ALERTA DE REIMPRESSยO",.T.)
...
TRCell():New(oSection1,"D2_TOTAL"   ,"SD2","Venda no"+CRLF+"Lํquido"+CRLF+"Total"	,           	,18,,,,,"RIGHT")
TRCell():New(oSection1,"QTDE"	    ,"   ","Perํodo"+CRLF+"Qtde"+CRLF+"Total"		,'@E 999,999'	,12,,,,,"RIGHT") 
TRCell():New(oSection1,"MEDIA"	    ,"   "," "+CRLF+"Media"+CRLF+"Mensal"			,				, 8,,,,,"RIGHT") 
TRCell():New(oSection1,"DIAEST"	    ,"   ","Dias"+CRLF+"ฺteis de"+CRLF+"Estocagem"	,'@E 9,999,999'	,15,,,,,"RIGHT") 

//29/05/15 - Rafael Leite - Incluido a pedido do Jaime
TRCell():New(oSection1,"DA1_PRCVEN"	,"DA1","Pre็o"+CRLF+"Capa"						,				,15)
 ...
 SELECT * FROM
  (SELECT B1_COD 
     ...
     WHERE SB2.B2_FILIAL    = %xFilial:SB2%
          ...
          AND SB5.B5_FILIAL = %xFilial:SB5%
          AND DA1.DA1_FILIAL = %xFilial:SB5%
          AND SB2.B2_COD = SB1.B1_COD  
          AND SB1.B1_COD = SB5.B5_COD
          AND TRIM(SB5.B5_XSELO) = TRIM(Z1.X5_CHAVE)
          AND TRIM(SB1.B1_XIDTPPU) = TRIM(Z4.X5_CHAVE)
          ...
          AND Z1.X5_TABELA = 'Z1'
          AND Z4.X5_TABELA = 'Z4'
          AND TRIM(SB1.B1_XSITOBR) IN ('101','105')
          AND TRIM(SB1.B1_XIDTPPU) NOT IN ('9','14','15','16','17','24','25','27')
