...
DESCRICAO: RELATORIO DE NOVIDADES NAO RECEBIDAS COM AS OBRAS DA ELSEVIER
...
oReport := TReport():New("GER056a","GER056a - NOVIDADES NÃO RECEBIDAS + ELSEVIER",cPerg,{|oReport| PrintReport(oReport)},"GER056a - NOVIDADES NÃO RECEBIDAS + ELSEVIER")
...
_cQuery += "            OR  TRIM(B5_XSELO) IN ('16','17','18'))
